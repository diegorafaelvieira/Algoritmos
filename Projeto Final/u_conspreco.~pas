...
procedure Tfr_conspreco.Button1Click(Sender: TObject);
begin
  ...
  then begin
         ...
         dm.q_consulta.sql.text := 'select * from carros where car_preco >= ' + Ed_campo1.text + ' and car_preco <= ' + ed_campo2.text;
         dm.q_consulta.open;
